...
class UI():
    ...
    def add_buttons(self):
        ...
        button2.pack(side=LEFT)
        # up_button = Button(self.frame, text="UP", fg="red", command=move_map_up)
        # up_button.pack(side=LEFT)
        # down_button = Button(self.frame, text="DOWN", fg="red", command=move_map_down)
        # down_button.pack(side=LEFT)
        # left_button = Button(self.frame, text="LEFT", fg="red", command=move_map_left)
        # left_button.pack(side=LEFT)
        # right_button = Button(self.frame, text="RIGHT", fg="red", command=move_map_right)
